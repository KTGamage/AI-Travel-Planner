...
import ParticlesComponent from '../ui/useParticles'


function Hero() {
  return (

      <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-orange-50 px-4 py-20 relative ">
